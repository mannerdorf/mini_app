...
import { normalizeNotificationPreferencesState, savePushSelectedInn } from "../lib/notificationEmailPrefs.js";

/** POST { login, token, platform?: "android" | "ios", inn? } — сохранить FCM token устройства. */
