...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  if (req.method === "POST") {
    const b = req.body;
    const { rows } = await pool.query(
      `INSERT INTO pnl_classification_rules (counterparty, purpose_pattern, operation_type, department, logistics_stage, direction)
       VALUES ($1, $2, $3, $4, $5, $6)
       ...
       RETURNING id, counterparty, purpose_pattern AS "purposePattern",
                 ...
                 logistics_stage AS "logisticsStage", direction,
                 created_at AS "createdAt"`,
      [b.counterparty, b.purposePattern || null, b.operationType, b.department, b.logisticsStage || null, b.direction || null]
    );
