...
export type SendingsSectionProps = {
  ...
  setSendingsSummarySortColumn: (column: "index" | "cargo" | "status" | "count" | "volume" | "weight" | "paidWeight" | "cost" | "customer" | "density") => void;
  setSendingsSummarySortOrder: (order: "asc" | "desc") => void;
