...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-[1.25rem] border border-[hsl(var(--guest-border))] bg-[hsl(var(--guest-card))] text-[hsl(var(--guest-card-foreground))] shadow-[0_8px_30px_rgba(15,23,42,0.06)]",
        className,
      )}
      {...props}
    />
...
const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p ref={ref} className={cn("text-sm text-[hsl(var(--guest-muted-foreground))]", className)} {...props} />
  ),
);
