...
curl -sS http://127.0.0.1:3000/api/admin-pickup-dispatch -H "Authorization: Bearer test" -H "Content-Type: application/json" -d '{"action":"snapshot","city":"moscow","date":"2026-09-15"}' | head -c 160; echo
