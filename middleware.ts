...
export const config = {
    matcher: [
        "/api/((?!cron/|perevozki|invoices|acts|orders|sendings|getperevozka|service-refresh-from-1c|admin-weekly-summary|admin-document-cache-backfill|wb/|haulz-returns/|haulz-calculator/).*)",
    ],
};
